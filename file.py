...
root.configure(bg="#5900ff")

month = ("January", "Feburary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December")

profits = (20000, 45000, 78000, 97000, 12000, 456000, 65000, 54000, 10000, 30000, 70000, 90000)

max_profits = Label(root,bg="#5900ff",fg="white")
min_profits = Label(root,bg="#5900ff",fg="white")
label_month = Label(root,bg="#5900ff",fg="white")
label_profit = Label(root,bg="#5900ff",fg="white")
...
btn1 = Button(root, text = "Show Max Profitable Month", command = maxprofit, bg="#038cfc", fg="white",border=0)
btn1.place(relx = 0.5,rely = 0.4, anchor = CENTER)
btn2 = Button(root, text = "Show Min Profitable Month", command = minprofit, bg="#038cfc", fg="white",border=0)    
